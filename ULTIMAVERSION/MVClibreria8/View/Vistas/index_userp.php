...
<head>
	<meta charset="utf-8">
	<meta name="description" content="Inicio de la pagina web como administrador">
	<meta name="autor" content="Yo">
	<title>Biblioteca DAP</title>
	<link rel="stylesheet" type="text/css" href="../css/index2admin.css">
</head>
<body>
	<nav>
		<ul>
		  ...
		  <li><a href="libro\consultar_libro.php">Libros</a>
		  </li>
		  <li><a href="">Prestamos</a>
			<ul>
				<li><a href="solicitud_prestamo\crear_prestamo.php">Crear Prestamo</a></li>
				<li><a href="solicitud_prestamo\consultar_prestamo.php">Consultar Prestamos</a></li>
			</ul>	
		  </li>
		  <li><a href="Sanciones\consultar_sancion.php">Sanciones</a>
		  </li>
		  <li><a href="Usuario\consultar_usuario.php">Usuarios</a>
		  </li>
	...
	<header>
		<h1>BIENVENIDO A LA BIBLIOTECA VIRTUAL D&Eacute;BORA ARANGO P&Eacute;REZ USUARIO PRIORITARIO</h1>
		<br><br>
	</header>
	<section>
		<div id="for_admins">
			<h1>GESTIONA Y DISFRUTA</h1>
			<br><br><hr>
			<p>El Col&eacute;gio Distrital D&eacute;bora Arango P&eacute;rez crea este espacio para que los administrativos del colegio puedan consultar los estudiantes ingresados a la plataforma, con el fin de obtener los registros de estos, también puedes acceder al catálogo de textos.</p><br><br><br><br><br><br><br><br>
	</section>
	<footer>
