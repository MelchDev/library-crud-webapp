...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Sancion">
...
require_once '../../../Controller/sancionController.php';
	...
	if(isset($_POST["save"]))
	{
		//$sqlCount = $mysql->query("select max(ID_sancion + 1) as Conteo from sanciones");
		$ES = $_POST["estado_sancion"];
		$desc = $_POST["descripcion"];
		$IDSP = $_POST["ID_solicitud_prestamo"];

		call_user_func_array(array('sancionController', 'crearSancion'), array($ES, $desc, $IDSP));
		...
		//	}
//
//		   	$sqlInsert = $mysql->query("INSERT INTO sanciones VALUES(" . $vlr . ", '" . $ES ."', '" . $desc ."', '" . $IDSP ."')");
//		}
	}
?>
	...
	<header>
		<form action="" method="POST">
			<p>Estado de la Sanción: 
			<br><br>
		    <input type="text" id="estado_sancion" name="estado_sancion" required="required"></p>
		    <br>
		    <p>Descrpción: 
			<br><br>
		    <input type="text" id="descripcion" name="descripcion" required="required"></p>
		    <br>
		    <p>ID Prestamo: 
			<br><br>
		    <input type="text" id="ID_solicitud_prestamo" name="ID_solicitud_prestamo" required="required"></p>
		    <br>
		    <p><input type="submit" value="Crear Sanción" name="save"></p>
		    <br>
		    <p><a href="gestionar_sancion.php">Consultar Sanciones</a></p><br>
		</form>
	</header>
	<footer>
