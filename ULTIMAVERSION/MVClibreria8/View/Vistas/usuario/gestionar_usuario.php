...
<?php
		...
		foreach($sqlResponse as $value){
			...
			<td><input type="text" name="updateRol" value="'.$value->rol.'"/></td>
		...
		{
			$txtNombre = $_POST['updateNombre'];
			$txtApellido = $_POST['updateApellido'];
			$txtContrasena = $_POST['updateContrasena'];
			$txtDoc = $_POST['updateDocumento'];
			$txtFN = $_POST['updateFechaNacimiento'];
			$txtCorreo = $_POST['updateCorreo'];
			$txtTel = $_POST['updateTelefono'];
			$txtRol = $_POST['updateRol'];
			$idUsuario = $_POST['identificador'];
			//$sqlUpdate = $mysql->query('UPDATE usuario SET nombre_usuario = "'.$txtNombre.'",apellido_usuario = "'.$txtApellido.'",contrasena = "'.$txtContrasena.'",documento = "'.$txtDoc.'",fecha_nacimiento = "'.$txtFN.'",correo = "'.$txtCorreo.'",telefono = "'.$txtTel.'",rol = "'.$txtRol.'" WHERE ID_usuario = '. $idUsuario);
			$response = call_user_func_array(array('usuarioController', 'actualizarUsuario'), array($txtNombre, $txtApellido, $txtContrasena, $txtDoc, $txtFN, $txtCorreo, $txtTel, $txtRol, $idUsuario));
		...
		{
			$idUsuario = $_POST['identificador'];
			//$sqlDelete = $mysql->query('DELETE FROM usuario WHERE ID_usuario = '. $idUsuario);
			$response = call_user_func_array(array('usuarioController', 'eliminarUsuario'), array($idUsuario));
